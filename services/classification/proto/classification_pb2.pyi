...
class StressLevelRequest(_message.Message):
    __slots__ = ["heart_rate", "systolic_blood_pressure", "diastolic_blood_pressure", "body_temp_c"]
    ...
    body_temp_c: float
    def __init__(self, heart_rate: _Optional[int] = ..., systolic_blood_pressure: _Optional[int] = ..., diastolic_blood_pressure: _Optional[int] = ..., body_temp_c: _Optional[float] = ...) -> None: ...
